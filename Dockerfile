...
RUN apt-get --no-install-recommends install -y \
     ...
     postgresql-18-pg-track-settings postgresql-18-pg-wait-sampling postgresql-18-cron postgresql-18-set-user postgresql-18-postgis postgresql-18-pg-stat-kcache postgresql-18-pgaudit postgresql-18-pg-qualstats postgresql-18-hypopg postgresql-18-powa postgresql-18-pg-hint-plan postgresql-18-pgnodemx postgresql-18-decoderbufs
